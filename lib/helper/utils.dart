...
//define the api key string variable
String apiKey = '3f7fb7e5e186e6824f55b9ac49a2da99';

//class that generates level of UV light
class UvIndex {
...
//class that generates verbs from noun
class MapString {
  ...
  //method with icon return that matches verbs with respective icons
